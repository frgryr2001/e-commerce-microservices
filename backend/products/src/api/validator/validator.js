...
exports.updateQuantityProductValidator = [
	check('products').exists().withMessage('Vui lòng truyền danh sách sản phẩm'),
	check('signal').exists().withMessage('Vui lòng truyền dấu'),
];
